          ...
          <div className="row g-5">
            <div className="col-lg-3 col-md-6">
              ...
              <div className="d-flex pt-2">
                <a className="btn btn-social" href="" target="_blank" rel="noopener noreferrer">
                ...
                <a className="btn btn-social" href="https://www.instagram.com/snap.greet/" target="_blank" rel="noopener noreferrer">
